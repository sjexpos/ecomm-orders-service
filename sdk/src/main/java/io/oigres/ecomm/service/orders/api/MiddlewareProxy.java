...
public class MiddlewareProxy implements InvocationHandler {
  ...
  public <T> CompletableFuture<? extends PageResponse<T>> getPageAsync(
      Function<UriBuilder, URI> uriFunction, Class<T> responseClass) {
    ParameterizedTypeReference<JacksonPageImpl<T>> typeReference =
        new ParameterizedTypeReference<JacksonPageImpl<T>>() {};
  ...
  public <T> CompletableFuture<T> putAsync(
      Function<UriBuilder, URI> uriFunction, Object requestData, Class<T> elementClass) {
  ...
  public <T> CompletableFuture<T> deleteAsync(
      Function<UriBuilder, URI> uriFunction, Class<T> responseClass) {
  ...
  public <T> CompletableFuture<T> patchAsync(
      Function<UriBuilder, URI> uriFunction, Object requestData, Class<T> elementClass) {
